let randomObject ={
    ...
    //randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board = {name: prompt("Escribe un nombre:")}
    randomObject["them"]["speed"]["past"]["program"]["grade"]["addition"]["whose"]["national"]["cannot"]["name"] = prompt("Escribe un nombre:");
