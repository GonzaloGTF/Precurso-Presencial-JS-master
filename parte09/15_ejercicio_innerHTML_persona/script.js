...
let name = prompt("Escribe el nombre de la persona para identificar sus datos")
do{
if (name == "Bridgette McGuire"){
    break
}
else if (name == "Melinda Wheele"){
    break
}
else if(name == "Ward Fulton"){
    break
}
else if(name == "Tessa Sellers"){
    break
}
else if(name == "Kimberley Roberson"){
    break
}
else if(name == "Eleanor Stafford"){
    break
}
else if(name == "Crane Harris"){
    break
}
else{
    name = prompt("Nombre equivocado, escribe el nombre de la persona correcta")
}
}while(true)


document.querySelector(".picture").src = personas[name].picture;
document.querySelector(".name").innerHTML = personas[name].name;
document.querySelector(".age").innerHTML = personas[name].age;
document.querySelector(".email").innerHTML = personas[name].email;
document.querySelector(".address").innerHTML = personas[name].address;


document.querySelector("#content").style.backgroundColor = personas[name].eyeColor;
